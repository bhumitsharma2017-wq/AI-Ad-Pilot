    ...
    <div className="space-y-4">
      ...
      <div className="bg-white rounded-2xl border border-gray-100 p-5">
        ...
        <div className="grid md:grid-cols-2 gap-4">
          {audiences?.linkedin_targeting && Object.entries(audiences.linkedin_targeting as Record<string, string[]>).map(([key, values]) => (
            <div key={key}>
      ...
      <div className="bg-white rounded-2xl border border-gray-100 p-5">
        ...
        <div className="flex flex-wrap gap-2">
          {(creatives?.lead_gen_form_fields as string[] || []).map((field, i) => (
